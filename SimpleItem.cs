...
{
    /// <summary>
    /// Represents an InventoryItem object without relying on the Variables.itemsMaster to be ready. It's use prevents exceptions.
    /// </summary>
    public class ItemShell
    {
        /// <summary>
        /// The item's key in string format. ex: "planks"
        /// </summary>
        public string strItemkey = "[unknown]";
        /// <summary>
        /// The amount of the item this shell is representing.
        /// </summary>
        public int intAmount;
        /// <summary>
        /// Use when this shell represents an Item which is a SimpleItem object rather than a string key.
        /// </summary>
        ...
        /// 
        /// </summary>
        /// <param name="Key">String item key, ex: "planks"</param>
        ...
        /// 
        /// </summary>
        /// <param name="asThis">A SimpleItem object.</param>
        /// <param name="amount">Amount of item.</param>
    ...
    public class SimpleItem
    {
        ...
        /// <summary>
        /// Internal variable for holding top texture ID.
        /// </summary>
        ...
        /// <summary>
        /// Internal variable for storing bottom texture ID.
        /// </summary>
        ...
        /// <summary>
        /// Internal variable used to hold an ItemTypeServer.ItemTypeRaw representation of this item.
        /// </summary>
        ...
        /// <param name="blnDropsSelf">Set to true if this item should be automatically configured to drop itself when removed from the world.</param>
        ...
        protected void Rotate(Dictionary<string, ItemTypesServer.ItemTypeRaw> items)
        {
            try
            {
                ...
                XP.isPlaceable = true;
                XP.Drops = this.Drops;
                XP.overwrite = this.overwrite;
                if (this.maskItem != null) XP.maskItem = this.maskItem + "x+";
                ...
                XP.lightSource = this.lightSource;
                // use proper mesh
                XP.mesh = this.mesh;
                ...
                ZP.isPlaceable = true;
                ZP.Drops = this.Drops;
                ZP.overwrite = this.overwrite;
                if (this.maskItem != null) ZP.maskItem = this.maskItem + "z+";
                ...
                ZP.lightSource = this.lightSource;
                // use proper mesh
                ZP.mesh = this.meshZP;
                ...
                XM.isPlaceable = true;
                XM.Drops = this.Drops;
                XM.overwrite = this.overwrite;
                if (this.maskItem != null) ZM.maskItem = this.maskItem + "x-";
                ...
                XM.lightSource = this.lightSource;
                // use proper mesh
                XM.mesh = this.meshXM;
                ...
                ZM.isPlaceable = true;
                ZM.Drops = this.Drops;
                ZM.overwrite = this.overwrite;
                if (this.maskItem != null) ZM.maskItem = this.maskItem + "z-";
                ...
                ZM.lightSource = this.lightSource;
                // use proper mesh
                ZM.mesh = this.meshZM;
            }
            catch (Exception ex)
        ...
        {
            /// <summary>
            /// String item key of the item to be dropped.
            /// </summary>
            string type;
            /// <summary>
            ...
            int amount;
            /// <summary>
            /// The chance that this drop will occur when the block is removed from the world, from zero to one.
            /// </summary>
            float chance;
            ...
            /// 
            /// </summary>
            /// <param name="strType">String item key of the item to be dropped.</param>
            ...
            /// </summary>
            /// <param name="strType">String item key of the item to be dropped.</param>
            /// <param name="intAmount">Number of items to be dropped.</param>
            ...
            /// <param name="strType">String item key of the item to be dropped.</param>
            /// <param name="intAmount">Number of items to be dropped.</param>
            /// <param name="fltChance">The chance that this drop will occur when the block is removed from the world, from zero to one.</param>
            ...
            /// <summary>
            /// Returns this item in JSON format.
            /// </summary>
            /// <returns>A JSONNode object corresponding to an item's "description" property on the server.</returns>
        ...
        /// <summary>
        /// Used to store data on what, if any, light the block should emit.
        /// </summary>
        public class Light
        {
            ...
            /// </summary>
            /// <returns>A JSONNode containing this data.</returns>
            public JSONNode asJSONNode ()
            {
