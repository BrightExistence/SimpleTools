...
{
    /// <summary>
    /// Describes the degrees counter-clockwise of an image.
    /// </summary>
    public enum Rotation
    {
        /// <summary>
        /// The texture image face-up like you would look at it without craning your neck.
        /// </summary>
        zero = 0,
        /// <summary>
        /// The texture image rotated 90 degrees counter-clockwise.
        /// </summary>
        counter90d = 1,
        /// <summary>
        /// The texture image rotated 180 degrees counter-clockwise.
        /// </summary>
        counter180d = 2,
        /// <summary>
        /// The texture image rotated 270 degrees counter-clockwise.
        /// </summary>
        counter270d = 3
    }

    /// <summary>
    /// Describes the part of a texture desired.
    /// </summary>
    public enum TexturePart
    {
        /// <summary>
        /// The albedo is the most (and only) required type of any texture. It usually consists of an image
        /// that is like a camera's snapshot of the texture in average and even lighting conditions.
        /// </summary>
        albedo = 0,
        /// <summary>
        /// Can be used to make the texture appear to emit light, without actually creating a light source.
        /// </summary>
        emissive = 1,
        /// <summary>
        /// Can be used to make the texture appear three-dimensional.
        /// </summary>
        height = 2,
        /// <summary>
        /// [The author does not know what this does.]
        /// </summary>
        normal = 3
    }

    /// <summary>
    /// A class for making texture creation easy.
    /// </summary>
    public class SpecificTexture
    {
        ...
        /// <summary>
        /// The texture's albedo image.
        /// </summary>
        public string AlbedoPath;

        /// <summary>
        /// The texture's 'normal' image. (Not to be confused with the normally used 'albedo'.)
        /// </summary>
        public string NormalPath;

        /// <summary>
        /// The texture's emissive image.
        /// </summary>
        public string EmissivePath;

        /// <summary>
        /// The texture's height image.
        /// </summary>
        ...
        /// 
        /// </summary>
        /// <param name="strName">Texture name (no spaces).</param>
        /// <param name="strNAMESPACE">Mod namespace.</param>
