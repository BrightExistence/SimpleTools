...
namespace BrightExistence.SimpleTools
{
    ...
    /// <summary>
    /// A class to make recipe creation simple.
    /// </summary>
    public class SimpleRecipe
    {
        ...
        /// <param name="strNAMESPACE">This mod's namespace.</param>
        ...
        /// <summary>
        /// Adds an item which the player will gain when this recipe is crafted.
        /// </summary>
        /// <param name="resultItem">SimpleItem object holding the item to be added as a result.</param>
        /// <param name="amount">Number of items required.</param>
